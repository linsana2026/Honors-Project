# Identifying Which Genotypes & Phenotypes Came From Each Grandparent

Hello, my name is Luke Insana, and I decided to look more closely into the origin of my genome because I have been interested in my family history as long as I can remember, and as of my freshman year of my undergraduate program at the University of New Hampshire, I have learned that I really want to build a career in genealogy, and help other people find missing pieces of their families that are important to them. In my own personal genealogical research, I eventually recieved an AncestryDNA test as a gift to expand my family research, and what I have learned after looking at these results is that you explore who I am related, but HOW related I am to each of my family members. After sharing this research with my immediate family and closer extended family, both of my parents both decided to further support my genealogy career building by each taking their own AncestryDNA tests, and buying AncestryDNA tests for my three living grandparents at the time of late 2024 and early 2025. Since my paternal grandmother passed away in 2023, I was unable to have her DNA tested for genealogical research. Following this family participation, I began to learn from looking at three different generations of genomic data how DNA was truly inherited from parent to offspring, and how biological processes such as homolougous recombination randomly selects how related I am to each of my four grandparents. This disproves that all humans are equally 25% related to each of their four grandparents, but rather I am 29% related to my paternal grandmother, 28% related to my maternal grandfather, 22% related to my maternal grandmother, and 21% related to my paternal grandfather. With this new information intact, I then wanted to see if I could locate which of my chromosomes came from each of my four grandparents, since chromosomes go through homologous recombination and independent assortment randomly, with no way to trace very easily which alleles came from which sides of my family tree. Once I asked these questions, I learned I could download the AncestryDNA tests as .txt files, and use a coding language called R to plot each of my chromosomes based on which grandparent gave me each copy of my genes. Once these questions have been identified, I then learned that I could combine human GWAS data containing known phenotypes in the human population, with my personal genomic data, and was curious to learn how many of these risk alleles I inherited, and from which parent I got them from. Once I identified my risk alleles and their parent of origin, I was able to combine the grandparent of origin plots with the risk allele identification, to create a second set of plots using R that visually display not only where my maternal and paternal recombination events took place, but also the genomic location for each of the GWAS traits, so that I would be able to identify the grandparent of origin for each of my known traits from the known GWAS data as of 2026. Below are the methods and results of how I was able to accomplish my research goals and answer my personal family history questions.
...
<details>
<summary>📉 Figure 5: GWAS Plots Color Coded By Grandparent of Origin </summary>
